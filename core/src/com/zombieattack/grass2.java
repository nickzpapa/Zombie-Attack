...
public class grass2 implements Screen {
...
/**EDIT**/
		noClickZone = new NoClickZone("NoNoZones/level2.nono");
...
/**EDIT**/
		//spawning zombies
		zombieList.spawnZombie(-20, 424, Direction.RIGHT);
		if(zombieList.isLevelFinished()){
			musicManager.stop();
			optionsPreferences.setCurrentLevel(8);
			if(optionsPreferences.getLevel() <= optionsPreferences.getCurrentLevel())
				optionsPreferences.setLevel(9);
			((Game)Gdx.app.getApplicationListener()).setScreen(new NextLevel(new water2()));
		}
...
/**EDIT**/		RegZombie z = (RegZombie) iter.next();
				z.changeToY(258, 424, Direction.DOWN);
				z.changeToX(258, 272, Direction.LEFT);
				z.changeToY(98, 272, Direction.DOWN);
				z.changeToX(98, 136, Direction.RIGHT);
				z.changeToY(548, 136, Direction.UP);
				z.changeToX(548, 424, Direction.RIGHT);
				z.changeToY(674, 424, Direction.DOWN);
				z.changeToX(674, 272, Direction.RIGHT);
				z.move(batch, delta);
				if(z.health <= 0) {
...
/**EDIT**/		if(z.dx > 805 ) {
					...
					--playerLife;
					if(playerLife <= 0)
/**EDIT**/				((Game)Gdx.app.getApplicationListener()).setScreen(new GameOver(new grass2()));
				}
			}	
	...
	public void show() {	
		...
		zombieList = new ZombieList("SpawnTimes/test.wave");
	}
