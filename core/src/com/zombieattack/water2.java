...
public class water2 implements Screen {
...
/**EDIT**/
		noClickZone = new NoClickZone("NoNoZones/level5.nono");
...
/**EDIT**/
	...
	public void render(float delta) {
		...
		if(zombieList.isLevelFinished()){
			musicManager.stop();
			optionsPreferences.setCurrentLevel(5);
			if(optionsPreferences.getLevel() <= optionsPreferences.getCurrentLevel())
				optionsPreferences.setLevel(6);
			((Game)Gdx.app.getApplicationListener()).setScreen(new NextLevel(new sand2()));
		}
...
/**EDIT**/		RegZombie z = (RegZombie) iter.next();
				...
				z.changeToX(226, 464, Direction.RIGHT);
				z.changeToY(418, 464, Direction.DOWN);
				z.changeToX(418, 298, Direction.RIGHT);
				z.changeToY(546, 298, Direction.DOWN);
				z.changeToX(546, 168, Direction.RIGHT);
				z.changeToY(674, 168, Direction.UP);
				z.changeToX(674, 458, Direction.RIGHT);
				z.move(batch, delta);
				if(z.health <= 0) {
...
/**EDIT**/		if(z.dx > 805 ) {
					...
					--playerLife;
					if(playerLife <= 0)
/**EDIT**/				((Game)Gdx.app.getApplicationListener()).setScreen(new GameOver(new water2()));
				}
			}	
